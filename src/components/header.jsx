...
import { BriefcaseBusiness, PenBox, Save, ChevronDown, Sparkles } from "lucide-react";
...
const Header = () => {
 ...
 const openUserMenu = () => {
  ...
  return (
    <>
      <header className="sticky top-0 z-[100] w-full bg-white/70 backdrop-blur-xl supports-[backdrop-filter]:bg-white/60">
        {/* Top accent line */}
